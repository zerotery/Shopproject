        ...
        <div class="col-lg-1"></div>
          <div class="col-lg-10" style="border-style:solid;border-width:2px;">
             ...
             <div class="table-responsive animated fadeInDown" id="users">
                  <div class="col-md-1">Search</div><div class="col-lg-1  col-sm-1 input-group date" id='datetimepicker2'>
                     
                      <input type="text" id="pay_date" class="form-control" name="paydate" style="width:150px;height:25px" data-date-format="YYYY-MM-DD" >
                         ...
                         <tbody class="list">
                          ...
                          <?php
                               ...
                               for($i=0; $i<count($result); $i++){
                                ...
                                echo '<td class="warning" style="font-size:11pt" >'.$result[$i]['member_name'].'</td>';
                                echo '<td class="warning" style="font-size:11pt" >'.$result[$i]['email_tranfer'].'</td>';
                                ...
                                echo '<td class="warning" style="font-size:11pt" >'.$result[$i]['payment'].'</td>';
                                echo '<td class="warning payment_date" style="font-size:11pt" >'.$result[$i]['date'].'</td>';
                                echo '<td class="warning" style="font-size:11pt" >'.$result[$i]['tranfer_time'].'</td>';
                                ...
                                echo '<td class="warning" style="font-size:11pt" >'.$result[$i]['more_detail'].'</td>';
