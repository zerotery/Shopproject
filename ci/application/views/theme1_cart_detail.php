          ...
          <div class="col-xs-12 col-sm-12 bborder" >
              ...
              <table class="table" id="product-table" style="width:100%;border: 2px solid #eee">
                ...
                foreach($this->cart->contents() as $items){
                  ...
                  echo '<td style="border: 1px solid #eee"><div id="delete_order[]" class="btn glyphicon glyphicon-trash btn-remove " style="color:red" onclick="javascript:location.href=\''.site_url().'cashshop/delete_cart'.'?row_id='.$items['rowid'].'&sid='.$s_id.' \'"></div></td>';
                  //echo $items['rowid'].'<br>';
                  $i++;
         ...
         <div class="table-responsive ">
          <td><table class="table" style="width:100%;border: 2px solid #eee" >
            <tbody>
              ...
              <tr>
                <td><input type="radio" name="post" id="registered" ></td><td><?=$this->lang->line("domestic_registered");?></td><td>+ 0.00 <font class="space2"><?=$this->lang->line("monetary");?></font></td><td><?php echo $this->cart->format_number($this->cart->total()); ?><font class="space2"><?=$this->lang->line("monetary");?></font></td>
              </tr>
              <tr>
              <?php 
              ...
              ?>
                <td><input type="radio" name="post" id="ems"></td><td><?=$this->lang->line("domestic_ems");?></td><td>+ 80.00 <font class="space2"><?=$this->lang->line("monetary");?></font></td><td><?php echo $cart;  ?><font class="space2"><?=$this->lang->line("monetary");?></font></td>
              </tr>
