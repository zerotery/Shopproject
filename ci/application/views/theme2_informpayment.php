                  ...
                  if($layout==0){
                    ...
                    for($i=0;$i<count($layout);$i++){
                      ...
                      if($layout[$i]['type_layout']==1){
                        ...
                        echo '<li class="active animated m_hover"><a class="animated-pay fadeInRight2" href="'.site_url('Shop/informpayment/2').'/'.$s_id.'">'.$this->lang->line("t_pay").'<span class="sub_icon glyphicon glyphicon-usd glyphicon-green"></span></a></li>';
