...
<div class="bs-docs-section clearfix">
        ...
        <div class="col-lg-1"></div>
          <div class="col-lg-10" style="border-style:solid;border-width:2px;">
                ...
                <form class="form-horizontal" name="editgallery" id="edit_g" action="<?php echo site_url('backshop/process_modify');?>"  method="post" enctype="multipart/form-data">
                    <fieldset >
                                                   ...
                                                   <div class="form-group animated fadeInUp">
                                                     <div class="col-lg-4">
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                          ...
                                                          <div>
                                                            <span class="btn btn-success btn-file "><span class="fileinput-new "><?=$this->lang->line("select_pic");?></span><span class="fileinput-exists "><?=$this->lang->line("change_pic");?></span><input type="file" name="modify_gallery"></span>
