    ...
    <body>
        ...
        <div class="modal-content" style="background-color: #6CA6CD;">
              ...
              <div class="modal-header" style="background-color:#6CA6CD;">
                  ...
                  <h1 class="text-center" style="font-family: cursive; font-size:14pt"><?=$this->lang->line("e_waiting");?></h1>
                  <h2 class="text-center" style="font-family: cursive; font-size:14pt"><?=$this->lang->line("l_waiting");?></h2>
              </div>
...
countdown(function() {
    location.href ="<?php echo site_url('main/login'); ?>"
});
   </script>
